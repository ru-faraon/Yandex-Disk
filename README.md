...
https://oauth.yandex.ru/authorize?response_type=token&display=popup&client_id=<id приложения>

подставив вместо <id приложения> полученный в предыдущем пункте id.
